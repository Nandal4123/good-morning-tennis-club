const API_BASE = import.meta.env.VITE_API_URL || 
  (import.meta.env.PROD ? 'https://tennis-club-server.onrender.com/api' : '/api');
...
export const sessionApi = {
  ...
  update: (id, data) => fetchApi(`/sessions/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const attendanceApi = {
  ...
  mark: (data) => fetchApi('/attendances', { method: 'POST', body: JSON.stringify(data) }),
  quickCheckIn: (userId) => fetchApi('/attendances/checkin', { method: 'POST', body: JSON.stringify({ userId }) }),
  update: (id, data) => fetchApi(`/attendances/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const matchApi = {
  ...
  create: (data) => fetchApi('/matches', { method: 'POST', body: JSON.stringify(data) }),
  update: (id, data) => fetchApi(`/matches/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  delete: (id) => fetchApi(`/matches/${id}`, { method: 'DELETE' }),
  updateScore: (id, participantId, score) => 
    fetchApi(`/matches/${id}/score`, { method: 'POST', body: JSON.stringify({ participantId, score }) }),
};
...
export const feedbackApi = {
  ...
  create: (data) => fetchApi('/feedbacks', { method: 'POST', body: JSON.stringify(data) }),
  update: (id, data) => fetchApi(`/feedbacks/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
